...
, "Out.smoothsignalLU_generated.data" using 1:3 linecolor rgb "red" lt 2 ps 0.5 title "noisy signal"\
, "Out.smoothsignalLU_generated.data" using 1:4 linecolor rgb "blue" lt 7 ps 0.3 title sprintf(lambda_a)\
